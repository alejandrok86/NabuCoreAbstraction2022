...
namespace Octavo.Gate.Nabu.CORE.API.Controllers.Audit
{
    ...
    public class AuditEventController : ControllerBase
    {
        ...
        // GET api/<AuditEventController>/5
        [HttpGet("{id}")]
        ...
        // POST api/<AuditEventController>
        [HttpPost]
        public void Post([FromBody] string value)
        {
        }

        // PUT api/<AuditEventController>/5
        [HttpPut("{id}")]
        public void Put(int id, [FromBody] string value)
        {
        }

        // DELETE api/<AuditEventController>/5
        [HttpDelete("{id}")]
