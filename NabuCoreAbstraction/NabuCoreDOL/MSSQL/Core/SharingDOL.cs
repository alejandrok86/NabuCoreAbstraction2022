...
namespace Octavo.Gate.Nabu.CORE.DOL.MSSQL.Core
{
    public class SharingDOL : BaseDOL
    {
        ...
        public Sharing Get(int pShareID)
        {
            ...
            {
                SqlCommand sqlCommand = new SqlCommand("[SchCore].[Sharing_Get]");
                try
                {
                    sqlConnection.Open();
                    ...
                    if (sqlDataReader.Read())
                    {
                        ...
                        share.SharedBy = new Party(sqlDataReader.GetInt32(1));
        ...
        public Sharing[] List(int pPartyID)
        {
            ...
            using (SqlConnection sqlConnection = new SqlConnection(base.ConnectionString))
            {
                SqlCommand sqlCommand = new SqlCommand("[SchCore].[Sharing_List]");
                try
                {
                    sqlConnection.Open();
                    sqlCommand.Connection = sqlConnection;
        ...
        public Sharing Insert(Sharing pShare)
        {
            ...
            using (SqlConnection sqlConnection = new SqlConnection(base.ConnectionString))
            {
                SqlCommand sqlCommand = new SqlCommand("[SchCore].[Sharing_Insert]");
                try
                {
                    sqlConnection.Open();
                    sqlCommand.Connection = sqlConnection;
                    ...
                    share.SharedBy = new Party(pShare.SharedBy.PartyID);
        ...
        public Sharing Update(Sharing pShare)
        {
            ...
            using (SqlConnection sqlConnection = new SqlConnection(base.ConnectionString))
            {
                SqlCommand sqlCommand = new SqlCommand("[SchCore].[Sharing_Update]");
                try
                {
                    sqlConnection.Open();
                    sqlCommand.Connection = sqlConnection;
        ...
        public Sharing Delete(Sharing pShare)
        {
            ...
            using (SqlConnection sqlConnection = new SqlConnection(base.ConnectionString))
            {
                SqlCommand sqlCommand = new SqlCommand("[SchCore].[Sharing_Delete]");
                try
                {
                    sqlConnection.Open();
                    sqlCommand.Connection = sqlConnection;
